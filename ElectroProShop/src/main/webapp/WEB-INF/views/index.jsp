...
<div class="container">
	<div class="row">
		<div class="col-md-4">
			<div class="thumbnail">
				<a href="#"> <img src="${e}resources/images/slide1.jpg"
		...
		<div class="col-md-4">
			<div class="thumbnail">
				<a href="#"> <img src="${e}resources/images/slide2.jpg"
					alt="Image 2" style="width: 100%">
					<div class="caption">
						<p>Image 2</p>
					</div>
				</a>
		...
		<div class="col-md-4">
			<div class="thumbnail">
				<a href="#"> <img src="${e}resources/images/slide3.jpg"
					alt="Image 3" style="width: 100%">
					<div class="caption">
						<p>Image 3</p>
					</div>
				</a>
